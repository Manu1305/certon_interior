          ...
          <div className="single-content-wrap">
            <div className="w-layout-grid blog-single-grid">
              <div className="blog-single-content-wrap">
                <h1 className="blog-single-title">Dining Area</h1>
                <img
                ...
                <div className="w-richtext">
                  <p>
                    Indulge in our inviting dining areas, where culinary
                    experiences and conversations converge. Elegant furnishings,
                    ambient lighting, and thoughtful layouts create an intimate
                    atmosphere. Enjoy meals amidst tasteful decor, fostering
                    warmth and togetherness. Whether hosting gatherings or
                    savoring family dinners, our dining spaces elevate every
                    moment, making memories unforgettable.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <div className="blog-image-wrap">
                  ...
                  >
                    <img
                      src="/insidehome/diningArea/1.jpg"
                      loading="lazy"
                      alt="Blog Image"
            ...
            >
              ...
              >
                <div className="blog-image-wrap">
                  ...
                  >
                    <img
                      src="/insidehome/diningArea/2.jpg"
                      loading="lazy"
                      alt="Blog Image"
                      className="blog-listing-image"
                      height={280}
            ...
            >
              ...
              >
                <div className="blog-image-wrap">
                  ...
                  >
                    <img
                      src="/insidehome/diningArea/3.jpg"
                      loading="lazy"
                      alt="Blog Image"
                      className="blog-listing-image"
                      height={280}
